...
public class SubflowHandlerRegister extends HandlerComponentRegister<SubflowHandlerProperty> {
    ...
    public void doRegister(BeanDefinitionBuilder builder, SubflowHandlerProperty property) {
        ...
        String className = property.getResultHandler();
        if (className != null) {
            ...
            builder.addPropertyValue("resultHandler", ClassUtil.newInstance(className));
        }
    }
    ...
    public static class CustomGatewayMessageHandler extends GatewayMessageHandler {
        ...
        private RequestReplyMessageAggregator resultHandler;
        ...
        protected Object handleRequestMessage(Message<?> requestMessage) {
            ...
            return resultHandler.apply(requestMessage, replyMessage);
        }

        public void setResultHandler(RequestReplyMessageAggregator resultHandler) {
